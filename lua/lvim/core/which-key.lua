...
M.config = function()
  ...
  lvim.builtin.which_key = {
    ...
    vmappings = {
      ["/"] = conditional({ "<ESC><CMD>lua ___comment_gc(vim.fn.visualmode())<CR>", "Comment" }, has_comment),
    },
    mappings = {
      ["w"] = { "<cmd>w!<CR>", "Save" },
      ["q"] = { "<cmd>q!<CR>", "Quit" },
      ["/"] = conditional({ "<cmd>lua require('Comment').toggle()<CR>", "Comment" }, has_comment),
      ...
      l = {
        name = "LSP",
        a = conditional({ "<cmd>lua require('lvim.core.telescope').code_actions()<cr>", "Code Action" }, has_telescope),
      ...
      L = {
        ...
        f = conditional(
          { "<cmd>lua require('lvim.core.telescope').find_lunarvim_files()<cr>", "Find LunarVim files" },
          has_telescope
        ),
        g = conditional(
          { "<cmd>lua require('lvim.core.telescope').grep_lunarvim_files()<cr>", "Grep LunarVim files" },
          has_telescope
        ),
