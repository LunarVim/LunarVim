...
---@deprecated use luasnip.locally_jumpable instead
M.methods.jumpable = function(dir)
  local status_luasnip_ok, luasnip = pcall(require, "luasnip")
  if not status_luasnip_ok then
    return
  end

  return luasnip.locally_jumpable(dir)
end
  ...
  lvim.builtin.cmp = {
    ...
    mapping = cmp.mapping.preset.insert {
      ...
      ["<CR>"] = cmp.mapping(function(fallback)
        ...
        if not luasnip.locally_jumpable() or not luasnip.jump() then
          fallback()
        end
      end),
    },
