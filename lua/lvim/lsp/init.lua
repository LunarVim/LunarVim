...
local function lsp_code_lens_refresh(client)
  ...
  if vim.tbl_get(client.server_capabilities, "codeLensProvider") then
...
local function select_default_formater(client)
  if client.name == "null-ls" or not vim.tbl_get(client.server_capabilities, "documentFormattingProvider") then
    return
  end
