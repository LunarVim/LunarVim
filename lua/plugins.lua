...
config = function() require('nvim-ts-autotag').setup() end,
        ...
        -- Explorer
        use {"kyazdani42/nvim-tree.lua", cmd = "NvimTreeToggle", event = {"VimEnter", "BufReadPre","ColorScheme"}, config = function() require('lv-nvimtree') end}
        ...
        use {"terrortylor/nvim-comment", cmd = "CommentToggle", config = function() require("lv-comment") end}
