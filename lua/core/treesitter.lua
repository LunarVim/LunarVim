...
M.setup = function()
  ...
  -- }
  -- Custom text objects
  -- local textobj_prefixes = lvim.treesitter.textobj_prefixes
  -- local textobj_suffixes = lvim.treesitter.textobj_suffixes
  -- local textobj_sel_keymaps = {}
  -- local textobj_swap_keymaps = {}
  -- local textobj_move_keymaps = {
  --   enable = lvim.plugin.ts_textobjects,
  ...
  --   end
  -- end
  -- vim.g.ts_hint_textobject_keys = lvim.treesitter.hint_labels -- Requires https://github.com/mfussenegger/nvim-ts-hint-textobject/pull/2
  --
  ...
  treesitter_configs.setup(lvim.treesitter)
end
